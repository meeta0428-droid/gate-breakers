...
# First, remove the old multi-attack block from inside `if (actualDmg > 0)`
old_block = """            if (els.chkMultiAttack && els.chkMultiAttack.checked) {
...
# Now insert the new multi-attack logic right before `if (actualDmg > 0)`
new_block = """
