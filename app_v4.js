import { Character, calculateDamageFromCards, calculateDefenseFromCards, executeCardEffects, triggerHook } from './game_logic_v8.js';
...
function setupEvents() {
    ...
    function processReaction(inputDmg) {
        ...
        if (reactionDmg > 0) {
            ...
            logMsg(`【反撃】リアクション配置カードの攻撃効果！敵に <span class="damage">${totalCounterDmg}</span> のダメージを与えた！`, 'important');
