...
const els = {
    ...
    btnTriggerPassive: (function(){ const b = document.getElementById('btn-trigger-passive'); const clone = b.cloneNode(true); b.parentNode.replaceChild(clone, b); return clone; })(),
...
window.triggerPassiveEffect = function(passiveCard, originalIdx) {
    if (!passiveCard) return;
    ...
    if (isCombo) {
        ...
        if (isPassive) {
            ...
            if (els.btnTriggerPassive) {
                ...
                els.btnTriggerPassive.onclick = () => { triggerPassiveEffect(card, index); };
                if (card.name === '錬金術師') {
